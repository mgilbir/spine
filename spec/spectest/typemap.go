...
var DMLTypeMap = map[string]reflect.Type{
	...
	"schemeClr": reflect.TypeOf(dml.SchemeClrTransform{}),
	...
	// Diagram background and wordprocessing shape (xml_misc.go)
	"bg":  reflect.TypeOf(dml.DiagramBg{}),
	"wsp": reflect.TypeOf(dml.Wsp{}),

	// Chart print settings page setup (§21.2.2.134, chart/types.go)
	"pageSetup": reflect.TypeOf(chart.PageSetup{}),
