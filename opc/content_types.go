...
const (
	...
	// ContentTypeChart is the DrawingML chart part content type (c:chartSpace),
	...
	// docx/pptx chart references to carry its editable data. Note it is the
	// "sheet" package type, not the "sheet.main+xml" main-part type
